...
connection_string = 'Driver={ODBC Driver 17 for SQL Server};Server=tcp:serversprints.database.windows.net,1433;Database=sprintdemo1;Uid=mugsprint;Pwd=Mar09151999(;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;'
